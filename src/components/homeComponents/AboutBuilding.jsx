            ...
            <div className='shadow-lg rounded-lg'>
                <div className='flex flex-col lg:flex-row gap-6 justify-center items-center  '>
                    <div className='lg:w-1/2'>
                        <img src="/image/image (3).webp" className='w-full rounded-t-lg lg:rounded-none lg:rounded-tl-lg' alt="" />
                    </div>
                ...
                <div className='flex flex-col lg:flex-row-reverse gap-6 justify-center items-center  rounded-lg '>
                    <div className='lg:w-1/2'>
                        <img src="/image/image (4).webp" className='w-full rounded-t-lg lg:rounded-none ' alt="" />
                    </div>
                    <div className='lg:w-1/2 space-y-4 flex flex-col justify-between gap-4 p-8 '>
                ...
                <div className='flex flex-col lg:flex-row gap-6 justify-center items-center  rounded-lg '>
                    <div className='lg:w-1/2'>
                        <img src="/image/image (1).webp" className='w-full rounded-t-lg lg:rounded-none lg:rounded-bl-lg' alt="" />
                    </div>
                    <div className='lg:w-1/2 space-y-4 flex flex-col justify-between gap-4 p-8 '>
